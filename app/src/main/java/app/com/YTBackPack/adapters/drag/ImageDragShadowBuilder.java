package app.com.YTBackPack.adapters.drag;
...
public final class ImageDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public static View.DragShadowBuilder fromResource(Drawable drawable) {
        ImageDragShadowBuilder builder = new ImageDragShadowBuilder();
        ...
        builder.shadow.setBounds(0, 0, builder.shadow.getIntrinsicWidth(), builder.shadow.getIntrinsicHeight());
